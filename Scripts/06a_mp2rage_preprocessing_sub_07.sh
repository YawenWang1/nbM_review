...
# Get from sri
#-------------------------------------------------------------------------------
# gunzip -c ${anatPth}sub-07_ses-002_acq-MP2RAGE_run-1_mod-INV2_T1w.nii.gz > ${anat_Pth}sub-07_ses-002_acq-MP2RAGE_run-1_mod-INV2_T1w.nii
# gunzip -c ${anatPth}sub-07_ses-002_acq-MP2RAGE_run-1_mod-INV1_T1w.nii.gz > ${anat_Pth}sub-07_ses-002_acq-MP2RAGE_run-1_mod-INV1_T1w.nii
# gunzip -c ${anatPth}sub-07_ses-002_acq-MP2RAGE_run-1_mod-UNI_T1w.nii.gz > ${anat_Pth}sub-07_ses-002_acq-MP2RAGE_run-1_mod-UNI_T1w.nii
...
${anat_Pth}/sub-07_non_brainmask.nii.gz
...
-sub 1 \
-mul -1 \
${anat_Pth}/sub-07_non_brainmask_ivt.nii.gz
# Calculate brains to fit to freesurfer
fslmaths \
${UNI} \
-mul ${anat_Pth}/mINV2_brainmask.nii.gz \
-mul ${anat_Pth}/sub-07_non_brainmask_ivt.nii.gz \
${anat_Pth}/sub-07_UNI_brain.nii.gz
# Get T1 brain
fslmaths \
${anat_Pth}/T1map_corrected.nii.gz \
-mul ${anat_Pth}/mINV2_brainmask.nii.gz \
${anat_Pth}/sub-07_T1_brain.nii.gz
# -mul ${anat_Pth}/sub-07_non_brainmask_ivt.nii.gz \
# ${anat_Pth}/sub-07_T1_brain.nii.gz
...
cp ${anat_Pth}/sub-07_T1_brain.nii.gz ${fsPth}/sub-07_T1_brain.nii.gz
cp ${anat_Pth}/sub-07_UNI_brain.nii.gz ${fsPth}/sub-07_UNI_brain.nii.gz
...
codePth='/media/h/P04/Data/BIDS/code/sub-07/'
subjid='sub-07'
${codePth}06c_run_MP2RAGE_Freesurfer_fixed.sh \
${subjid} \
${fsPth}/sub-07_UNI_brain.nii.gz \
${fsPth}/sub-07_T1_brain.nii.gz \
${fsPth}/expert.opts
