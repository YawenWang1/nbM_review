...
${anat_Pth}/sub-12_non_brainmask.nii.gz
...
-sub 1 \
-mul -1 \
${anat_Pth}/sub-12_non_brainmask_ivt.nii.gz
# Calculate brains to fit to freesurfer
fslmaths \
${UNI} \
-mul ${anat_Pth}/mINV2_brainmask.nii.gz \
-mul ${anat_Pth}/sub-12_non_brainmask_ivt.nii.gz \
${anat_Pth}/sub-12_UNI_brain.nii.gz
# Get T1 brain
fslmaths \
${anat_Pth}/calcT1map_corrected_clean.nii \
-mul ${anat_Pth}/mINV2_brainmask.nii.gz \
${anat_Pth}/sub-12_T1_brain.nii.gz
...
cp ${anat_Pth}/sub-12_T1_brain.nii.gz ${fsPth}/sub-12_T1_brain.nii.gz
cp ${anat_Pth}/sub-12_UNI_brain.nii.gz ${fsPth}/sub-12_UNI_brain.nii.gz

cp /media/g/P04/Data/BIDS/sub-03/ses-002/anat/fs/expert.opts ${fsPth}/expert.opts
...
codePth='/media/h/P04/Data/BIDS/code/sub-12/'
subjid='sub-12'
${codePth}06c_run_MP2RAGE_Freesurfer_fixed.sh \
${subjid} \
${fsPth}/sub-12_UNI_brain.nii.gz \
${fsPth}/sub-12_T1_brain.nii.gz \
${fsPth}/expert.opts
