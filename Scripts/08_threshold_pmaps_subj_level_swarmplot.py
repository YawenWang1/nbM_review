...
# This directory includes probabilistic maps of nbM that was registered to five
# participants, and the pMaps are in native space. 
# =============================================================================
...
# Change current directory to pMapsPth
os.chdir(pMapsPth)
# Load the all the nifti files in the current directory
...
#%% Load probabistic maps from zaborszky et al 2019 version 4.2 and convert it 
# to panda dataframe
# =============================================================================
...
#%% Load Julich brain version 2.2 and convert it to panda dataframe
